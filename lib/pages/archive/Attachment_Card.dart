...
class attachment_archive_card extends StatefulWidget {
  final Archive_Model archive_model;
  final int index;

  attachment_archive_card({required this.archive_model, required this.index});

  @override
  State<attachment_archive_card> createState() =>
      _attachment_archive_cardState();
}

class _attachment_archive_cardState extends State<attachment_archive_card> {
  ...
  Widget build(BuildContext context) {
    ...
    Tittle = widget.archive_model.Attachment[widget.index]
        .toString()
        .split("2F")
        .last
        .split("?alt")
  ...
  Future Download_Attachmnet() async {
    ...
    final url = widget.archive_model.Attachment[widget.index];
