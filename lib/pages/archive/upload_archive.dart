...
class UploadArchive extends StatefulWidget {
  @override
  _UploadArchive createState() => _UploadArchive();
}

class _UploadArchive extends State<UploadArchive> {
  ...
  Future Upload() async {
    ...
    // print(filesUrl);
    var firestore =
        await FirebaseFirestore.instance.collection("Archive").doc();
