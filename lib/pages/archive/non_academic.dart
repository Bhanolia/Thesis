...
class Archive_NonAcademic extends StatefulWidget {
  @override
  _Archive_NonAcademic createState() => _Archive_NonAcademic();
}

class _Archive_NonAcademic extends State<Archive_NonAcademic> {
    ...
    return WillPopScope(
        child: Scaffold(
          appBar: AppBar(
            actions: <Widget>[],
            elevation: 0.0,
            title: Text("Archive Non-Academic"),
