...
class Announcement_Academic extends StatefulWidget {
  @override
  _Announcement_Academic createState() => _Announcement_Academic();
}

class _Announcement_Academic extends State<Announcement_Academic> {
    ...
    return WillPopScope(
        child: Scaffold(
          appBar: AppBar(
            actions: <Widget>[],
            elevation: 0.0,
            title: Text("Announcement Academic"),
